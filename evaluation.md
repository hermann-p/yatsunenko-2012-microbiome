...
![PCuA of beta-diversity among children shows no clear grouping](figure/ClusteringChildren.png) 
...
![Barplots of SVM-classifier prediction of the 16S dataset. X-axis describes the number of features used. The features were selected by greatest variance. A blue horizontal line shows the prediction success of PAM clustering for comparison.](figure/Classifiers.png) 
...
![The number of OTUs per sample increases with age](figure/BacterialDiversityWithAge.png) 
