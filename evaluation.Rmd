...
```{r DiversityChildToAdult, cache=TRUE,echo=FALSE,fig.cap="The UniFrac distances start with high values at early ages, show a strong decline until approximately three years of age, and stay steadily low until adulthood."}
...
```{r Clustering, cache=FALSE, echo=FALSE}
betaAdults <- getBetaGroup("Age", c(18,100), range=TRUE)
...
```{r Classifiers, cache=TRUE,echo=FALSE,fig.cap="Barplots of SVM-classifier prediction of the 16S dataset. X-axis describes the number of features used. The features were selected by greatest variance. A blue horizontal line shows the prediction success of PAM clustering for comparison."}
require(e1071)
...
```{r BacterialDiversityWithAge, echo=FALSE, fig.cap="The number of OTUs per sample increases with age"}
rarefaction <- 188517
